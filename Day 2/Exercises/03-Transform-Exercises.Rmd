...
Import the `babynames.csv` data set, which is in the `data` folder, as `babynames`. Then put the import code into the code chunk below. Make sure that you can run from there - you might need to adjust the path.
