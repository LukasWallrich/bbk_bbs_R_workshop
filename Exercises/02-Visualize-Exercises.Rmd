...
Add a setup chunk that loads the tidyverse packages and the dataset. For the dataset, use `ess_mini <- read_rds("ess_mini.RDS")` *after* you have loaded the tidyverse.
